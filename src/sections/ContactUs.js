            ...
            <Card className="rounded shadow border-0" data-aos="fade-up" data-aos-duration="1000">
              <CardBody>
                <div className="custom-form bg-white">
                  <div id="message"></div>
                  <Alert color="info" isOpen={state.successMsg} toggle={() => { setState({ successMsg: !state.successMsg }) }}>
                ...
                <CardBody className="p-0">
                  <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                    ...
                    <div className="content overflow-hidden d-block">
                      ...
                      <Link href="#" className="text-primary">contact@example.com</Link>
                    </div>
                  </div>
                </CardBody>
              </Card>
                ...
                <CardBody className="p-0">
                  <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                    ...
                    <div className="content overflow-hidden d-block">
                      ...
                      <Link href="#" className="text-primary">+152 534-468-854</Link>
                    </div>
                  </div>
                </CardBody>
              </Card>
                ...
                <CardBody className="p-0">
                  <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                    ...
                    <div className="content overflow-hidden d-block">
                      ...
                      <Link href="#" className="text-primary">View on Google map</Link>
                    </div>
                  </div>
                </CardBody>
              </Card>
